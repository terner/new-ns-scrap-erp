...
- During clone/migration batches, treat the legacy/Vue screen as the visual baseline first. Preserve card layout, colors, banners, tables, button placement, labels, and spacing unless a difference is documented and approved.
