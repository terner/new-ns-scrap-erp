    ...
    <section className="space-y-4">
      ...
      <div className="grid grid-cols-1 gap-4 lg:grid-cols-3">
        <Panel title=" กำไร vs เงินสดจริง">
          <Bar label="กำไรสุทธิ (Accrual)" max={maxProfit} tone="emerald" value={data?.summary.netProfit ?? 0} />
          <Bar label="กระแสเงินสดจากการดำเนินงาน" max={maxProfit} tone="blue" value={data?.summary.operatingCashFlow ?? 0} />
