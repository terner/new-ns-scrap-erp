                  ...
                  {paginatedSuppliers.map((supplier) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <TableCell className="text-center text-xs font-semibold text-slate-700">
                        <TableActionButton label="แก้ไข" menu={<TableActionMenuItem onSelect={() => void openEditForm(supplier)}>แก้ไข</TableActionMenuItem>} />
                        </TableCell>
                      </TableRow>
                    )
                  })}
              ...
              return (
                ...
                >
                  ...
                  <div className="mt-3 flex justify-end border-t border-slate-100 pt-2" onClick={(event) => event.stopPropagation()}>
                    <TableActionButton mobileLabel menu={<TableActionMenuItem onSelect={() => void openEditForm(supplier)}>แก้ไข</TableActionMenuItem>} />
                  </div>
                </div>
              )
            })}
