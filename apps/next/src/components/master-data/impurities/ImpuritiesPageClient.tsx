                ...
                <TableBody className="divide-y divide-slate-100">
                  {paginatedImpurities.map((impurity) => (
                    ...
                    >
                      ...
                      <TableCell className="text-center text-xs font-semibold text-slate-700">
                        <TableActionButton label="แก้ไข" menu={<TableActionMenuItem onSelect={() => openEditForm(impurity)}>แก้ไข</TableActionMenuItem>} />
                      </TableCell>
                    </TableRow>
                  ))}
            ...
            {paginatedImpurities.map((impurity) => (
              ...
              >
                ...
                <div className="mt-3 flex justify-end border-t border-slate-100 pt-2" onClick={(event) => event.stopPropagation()}>
                  <TableActionButton mobileLabel menu={<TableActionMenuItem onSelect={() => openEditForm(impurity)}>แก้ไข</TableActionMenuItem>} />
                </div>
              </div>
            ))}
            {paginatedImpurities.length === 0 ? (
