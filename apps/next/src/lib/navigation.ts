...
export const navigationItems: NavigationItem[] = [
  ...
  { href: '/trading/matching', icon: '🤝', label: 'Trading Matching / จับคู่ดีล', pageSubtitle: 'จับคู่บิลซื้อ Trading กับบิลขาย Trading → คำนวณ GP ต่อดีล (ก่อน VAT)', section: 'daily' },
