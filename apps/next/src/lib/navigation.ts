...
export const navigationItems: NavigationItem[] = [
  ...
  { href: '/purchase/payments', icon: '💸', label: 'จ่ายเงิน Supplier', pageSubtitle: 'บันทึกเงินออกจากบัญชีและดูแท็บประวัติการจ่ายเงิน', section: 'daily' },
  {
  ...
  { href: '/daily/petty-advance', icon: '🏦', label: 'เงินสำรองจ่าย / กู้กรรมการ', pageSubtitle: 'ติดตามยอดยืมของกรรมการ/พนักงาน รายละเอียดบิลที่ใช้เงินแต่ละก้อน และการคืนเงิน', section: 'daily' },
