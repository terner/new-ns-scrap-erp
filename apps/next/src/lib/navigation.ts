...
const exactPathPermissions: Record<string, string> = {
  ...
  '/stock/planning': REPORT_PAGE_PERMISSIONS.reportsIndex,
...
export const navigationItems: NavigationItem[] = [
  ...
  { href: '/finance/cash-position', icon: '💼', label: 'Cash Position', section: 'finance-debt' },
  {
    ...
    icon: '💱',
    label: 'เงินตราต่างประเทศ / FCD',
    section: 'finance-debt',
    children: [
      { href: '/finance/foreign/fcd-ledger', icon: '📒', label: 'FCD Ledger', section: 'finance-debt' },
      { href: '/finance/foreign/fcd-conversions', icon: '🔄', label: 'แลกเงิน FCD', section: 'finance-debt' },
      { href: '/finance/foreign/fcd-revaluations', icon: '🧮', label: 'ปิดงวด FCD', section: 'finance-debt' },
      { href: '/finance/foreign/fx-rate', icon: '📈', label: 'FX Rate', section: 'finance-debt' },
      { href: '/finance/foreign/fx-gain-loss-report', icon: '📊', label: 'รายงาน FX Gain/Loss', section: 'finance-debt' },
    ],
  },
