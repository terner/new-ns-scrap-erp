      ...
      bottomSectionHtml = `
        ...
        <div class="signatures">
          <div class="sig">
            ...
            <div style="font-size:8px;margin-top:2px">${escapeHtml(dateTimeDisplay(po.createdAt))}</div>
          </div>
          <div class="sig">
            <div>ผู้ประสานงานขาย / Sales Coordinator</div>
            <div class="sig-line">&nbsp;</div>
            <div style="font-size:8px;margin-top:2px">วันที่ ______/______/______</div>
          </div>
          <div class="sig">
