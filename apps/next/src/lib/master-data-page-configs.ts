...
export const accountsPageConfig: MasterDataPageConfig = {
  ...
  fields: [
    { key: 'accountGroup', label: 'ประเภทบัญชี', type: 'select', required: true, optionsApiPath: '/api/master-data/account-categories', optionValueKey: 'code', section: 'ข้อมูลบัญชี' },
    { key: 'branchId', label: 'สาขาบริษัท', type: 'select', required: true, optionsApiPath: '/api/master-data/branches', optionValueKey: 'code', section: 'ข้อมูลบัญชี' },
    { key: 'name', label: 'ชื่อบัญชีบริษัท', required: true, section: 'ข้อมูลบัญชี' },
    { key: 'bankAccountType', label: 'ประเภทบัญชีธนาคาร', type: 'select', required: true, options: [{ label: 'ออมทรัพย์', value: 'savings' }, { label: 'กระแสรายวัน', value: 'current' }], section: 'ข้อมูลบัญชี' },
    { key: 'bankName', label: 'ธนาคาร', type: 'select', optionsApiPath: '/api/master-data/bank-names', section: 'ข้อมูลบัญชี' },
    { key: 'bankBranch', label: 'สาขาธนาคาร', section: 'ข้อมูลบัญชี' },
    { key: 'accountNo', label: 'เลขที่บัญชี', section: 'ข้อมูลบัญชี' },
    { key: 'isFcd', label: 'เป็นบัญชี FCD', type: 'select', required: true, options: [{ label: 'ไม่ใช่บัญชี FCD', value: 'false' }, { label: 'ใช่บัญชี FCD', value: 'true' }], section: 'ข้อมูลบัญชี' },
    { key: 'currency', label: 'สกุลเงินหลัก', type: 'select', optionsApiPath: '/api/master-data/currencies', optionValueKey: 'code', required: true, section: 'สกุลเงินบัญชี' },
    { key: 'accountCurrencyBalances', label: 'สกุลเงินเพิ่มเติม', type: 'currency-balances', optionsApiPath: '/api/master-data/currencies', optionValueKey: 'code', required: true, section: 'สกุลเงินบัญชี' },
    { key: 'hasOd', label: 'มีวงเงิน OD', type: 'select', options: [{ label: 'ไม่มีวงเงิน OD', value: 'false' }, { label: 'มีวงเงิน OD', value: 'true' }], section: 'วงเงิน OD' },
    { key: 'odLimit', label: 'วงเงิน OD', type: 'number', inputFormat: 'money', section: 'วงเงิน OD' },
  ],
  columns: [
    { key: 'code', label: 'รหัส', align: 'center', width: 110, minWidth: 90 },
    { key: 'name', label: 'ชื่อบัญชีบริษัท', align: 'center', width: 220, minWidth: 170 },
    { key: 'subtypeLabel', label: 'ประเภทบัญชีธนาคาร', align: 'center', width: 160, minWidth: 135 },
    { key: 'bankName', label: 'ธนาคาร', align: 'center', width: 150, minWidth: 120 },
    { key: 'bankBranch', label: 'สาขาธนาคาร', align: 'center', width: 150, minWidth: 125 },
    { key: 'accountNo', label: 'เลขที่บัญชี', align: 'center', width: 160, minWidth: 135 },
    { key: 'currencyDisplay', label: 'สกุลเงิน', align: 'center', width: 130, minWidth: 110 },
    { key: 'branchName', label: 'สาขาบริษัท', align: 'center', width: 150, minWidth: 120 },
