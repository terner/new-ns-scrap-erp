          ...
          <section className="rounded-md border border-slate-100 p-4">
            ...
            <div className="space-y-3 lg:hidden">
              {bill.items.length === 0 ? (
                ...
                <div key={item.lineNo} className="rounded-md border border-slate-200 bg-white p-4 shadow-sm">
                  ...
                  <>
                    <div className="space-y-2 lg:hidden">
                      {bill.sourceUsageFacts.map((fact) => (
                        <div key={fact.id} className="rounded-md border border-slate-100 bg-white p-3 shadow-sm">
                          <div className="flex items-start justify-between gap-3">
                            <div className="min-w-0">
