...
- For clone/migration batches, follow `docs/design.md` for shared design conventions and use legacy/Vue as the visual baseline unless a deviation is documented and approved.
