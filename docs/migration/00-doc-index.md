...
| Payment flow | `docs/notes/Payment Flow.md` | canonical payment/approval flow: `อนุมัติจ่ายเงิน`, split approval items, `รอจ่าย`, `PMA/PMT`, advance payment/deposit, payment history, and supplier advance refund rules |
