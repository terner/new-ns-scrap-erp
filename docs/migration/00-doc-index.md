...
| Stock status convert page flow | `docs/notes/Stock Status Convert Page Flow.md` | page-specific contract for `/stock/status-convert`: paired `SC` status conversion, RM/WIP/FG validation, and reconciliation/reverse policy gap |
