...
| Petty advance page flow | `docs/notes/Petty Advance Page Flow.md` | page-specific contract for `/daily/petty-advance` under Finance & Debt: `PADV` outstanding document, direct Payment Approval flow, director-loan bank movement, recipient/account snapshots, and no `PRET` runtime fallback |
