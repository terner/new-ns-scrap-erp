...
| Purchase bills page flow | `docs/notes/Purchase Bills Page Flow.md` | page-specific contract for `/purchase/bills`: create/edit/cancel PB, Stock/WTI allocation UI, supplier-swap button, void-old/create-new save semantics, ADV release, and `/daily/bill-swap-history` handoff |
