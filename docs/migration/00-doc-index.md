...
| Sales flow | `docs/notes/Sales Flow.md` | target sales flow: PO Sell, Pending Sale/PSALE, ใบส่งของ/WTO, Trading sales bill from purchase bills/Trading lines without stock-out, Sales Bill, Receipt, generated document numbers, Thai statuses, stock and AR effects |
