...
- D7b Deal Margin read baseline is implemented and validated locally. It reads `trading_deals` matched sales/purchase amounts and preserves the legacy purple/pink gross margin card layout.
...
1. Commit and push D7b Deal Margin; then continue Compare Margin read baseline.
