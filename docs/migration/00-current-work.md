...
1. Continue D3 Trading Dashboard after D2 checkpoint.
2. Keep Trading Dashboard read-first; no matching/allocation writes until cost pool and reconciliation rules are locked.
