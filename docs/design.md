...
- **Footer**: ใช้ `DialogFooter` หรือ Sticky container ติดอยู่ด้านล่างสุดโดยตรึงไว้เพื่อไม่ให้เลื่อนหลุดสายตา โดยมีกฎเกณฑ์ดังนี้:
  ...
  - **การจัดวางข้อมูลสรุปใน Footer บนหน้าจอเล็ก**: หากมีส่วนสรุปตัวเลข (Metrics) ในแถบ Footer เมื่อแสดงผลบนหน้าจอแคบ/แนวตั้ง (เช่น โหมดมือถือ หรือกล่องบีบตัว) ให้จัดวางข้อมูลสรุปนั้นอยู่กึ่งกลางหน้าจอ (Center alignment) และเว้นระยะห่างช่องไฟที่พอดีไม่หนาแน่นจนเกินไป (`gap-x-10 gap-y-4`) เสมอเพื่อความสมดุล
...
- 2026-06-13: เพิ่มดีไซน์ไกด์ไลน์สำหรับ Modal/Detail Popup (AcexPOS Dark Header Style, Grouped Cards Layout, Mobile Responsive layout และการสลับตารางเป็นการ์ดบนมือถือ), ตำแหน่งปุ่มสร้าง/จัดการ (Desktop page action buttons) ใน Filter Row, Table Auto-Stretch Layout Rules และกติกาการยุบรูปภาพสินค้า (Collapsible Product Image Picker)
