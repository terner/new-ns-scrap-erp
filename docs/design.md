...
- baseline card คือ white card + circular icon ฝั่งซ้าย + label `text-xs font-medium` + value `font-mono text-xl font-bold` + optional note `text-xs font-medium text-slate-500`
