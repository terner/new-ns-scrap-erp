...
- **Footer**: ใช้ `DialogFooter` ติดอยู่ด้านล่างสุดโดยตรึงไว้เพื่อไม่ให้เลื่อนหลุดสายตา จัดวางปุ่มยกเลิก/ตกลงชิดขวา
...
- 2026-06-13: เพิ่มดีไซน์ไกด์ไลน์สำหรับ Modal/Detail Popup (AcexPOS Dark Header Style, Grouped Cards Layout, Mobile Responsive layout และการสลับตารางเป็นการ์ดบนมือถือ) และ Table Auto-Stretch Layout Rules
