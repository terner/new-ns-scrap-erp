...
| `รายละเอียดใบรับ-ส่งของ` | ดูรายละเอียดเอกสารใน Modal จากหน้ารายการ, รูปสินค้า/รูปรถ, timeline, และ action เอกสาร | `/daily/weight-ticket-list` → `รายละเอียด` | ต้องมี action `พิมพ์`, `แชร์เข้า LINE`, `แก้ไข`, และ `ยกเลิก` ตามสถานะเอกสาร |
