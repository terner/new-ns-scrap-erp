...
| 6 | Lock ต้นทางหลังเลือกใบรับของ | ไม่ต้องกรอกเพิ่ม | ไม่มี | Draft PB | หลังเลือก WTI แล้ว ระบบต้องล็อก `ประเภทบิล`, `สาขา`, `ผู้ขาย`, และ `ใบรับของ`; หากต้องการเปลี่ยนต้องกด `ล้างใบรับของ` ก่อน เพื่อ reset รายการสินค้าและข้อมูลปลายทาง |
...
| 13 | ระบบลง stock ถ้าเป็นบิลเข้าสต๊อก | ไม่ต้องกรอกเพิ่ม | อาจเกิด stock ledger id ภายใน | Stock = `บันทึกแล้ว` | เพิ่ม stock และต้นทุน; ถ้าเป็นทองแดง/ทองเหลืองให้เข้า Cost Pool |
