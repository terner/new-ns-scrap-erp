...
- ถ้าสินค้าบริษัทจาก Stock ต้องถูกตัดออกจริง ให้ใช้ flow ขาย Stock/WTO/PSALE แยกต่างหาก; ห้ามให้ PB Trading เป็น owner ของ stock-out และห้ามให้ Trading sale line ตัด stock เอง
