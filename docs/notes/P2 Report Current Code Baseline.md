...
|---|---|---|---|
| Main Dashboard / Reports | `/owner-daily`, `/daily-report`, `/dashboard-overview` | `GET /api/dashboard-overview`; `/api/owner-daily` และ `/api/daily-report` เป็น dedicated route/service แยก scope | `reports.reports.view` |
