...
- **การอัปเดตคู่มือดีไซน์**: บันทึกแนวทางมาตรฐานดีไซน์ของโปรเจกต์ลงใน `docs/design.md` เช่น การนำกรอบนอก (Outer Wrapper) ของ KPI Cards ออกตามความชอบของผู้ใช้, การสไตลิ่งป๊อปอัป และสไตล์ตารางบนมือถือ เพื่อใช้เป็นมาตรฐานกลางของนักพัฒนาทุกคน
- **การปรับปรุงส่วนแสดงผลการ์ด KPI**: นำกรอบพื้นหลังสีเทา/ขอบมนและเงา (container ด้านหลัง) ที่ซ้อนกันทับการ์ด KPI ทั้ง 5 ใบออกในหน้า **รับเงิน Customer** เพื่อป้องกันการทับซ้อนและทำให้อ่านง่ายขึ้น (`MoneyMovementPageClient.tsx`)
