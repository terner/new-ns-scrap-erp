...
warehouse master for stock ledger/balance, RM/FG/WIP rules

## Page Responsibilities

- ดูแล master data ของ คลัง
...
- `GET/POST /api/master-data/warehouses`
- `PATCH /api/master-data/warehouses/[id]`
- `GET/POST /api/master-data/warehouses; item API by id exists`
