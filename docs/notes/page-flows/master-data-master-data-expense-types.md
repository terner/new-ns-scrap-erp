---
title: ประเภทค่าใช้จ่าย Page Flow
tags:
  - page-flow
  - menu
  - master-data
...
expense type master parent of expense categories

## Page Responsibilities

- ดูแล master data ของ ประเภทค่าใช้จ่าย
...
- `GET/POST /api/master-data/expense-types`
- `PATCH /api/master-data/expense-types/[id]`
- `GET/POST /api/master-data/expense-types; item API by id exists`
