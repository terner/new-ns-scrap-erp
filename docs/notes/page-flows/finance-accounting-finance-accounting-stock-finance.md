...
- เพิ่มตัวกรองในตารางเดียวกัน: ค้นหารหัส/ชื่อ/หมวด, หมวดสินค้า, และอายุ stock; ไม่ต้องมี filter สถานะเพราะสถานะถูกสรุปในกราฟด้านบนแล้ว
- ตาราง `สินค้าหมุนช้า / ควรเร่งระบาย` ต้องมี filter ของตัวเองเช่นกัน: ค้นหารหัส/ชื่อ/หมวด และหมวดสินค้า โดยไม่ต้องมีสถานะหรืออายุซ้ำเพราะชุดข้อมูลนี้เป็น Top 15 จากเงื่อนไขไม่ขายเกิน 60 วันอยู่แล้ว
- จัด toolbar ของตารางให้รวมจำนวนรายการ, Qty ตามตัวกรอง, มูลค่าตามตัวกรอง, และปุ่มคืนค่าตารางไว้ด้วยกัน
...
- ตาราง `Stock ทั้งหมด` ไม่ต้องแสดงคอลัมน์สถานะเป็น badge เพราะซ้ำกับกราฟสถานะด้านบน; ให้คงสถานะไว้เป็นตัวกรองและใช้กราฟสถานะเป็นภาพรวมหลัก
