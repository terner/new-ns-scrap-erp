...
supplier master used by POB/WTI/PB/ADV/PMA/PMT/AP

## Page Responsibilities

- ดูแล master data ของ ผู้ขาย
...
- `PATCH /api/master-data/suppliers/[id]`
- `GET/POST /api/master-data/suppliers; GET/PATCH /api/master-data/suppliers/[id]; export/import APIs exist`
