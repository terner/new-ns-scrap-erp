---
title: วิธีจ่าย/รับเงิน Page Flow
tags:
  - page-flow
  - menu
  - master-data
...
payment method master used by PMA/PMT/RCP/direct expense

## Page Responsibilities

- ดูแล master data ของ วิธีจ่าย/รับเงิน
...
- `GET/POST /api/master-data/payment-methods`
- `PATCH /api/master-data/payment-methods/[id]`
- `GET/POST /api/master-data/payment-methods; item API by id exists`
