...
| Filters on mobile | จัดเดือน/สินค้าเป็น field เต็มแถวและห่อ label + control ของหมวด/ช่องทางเป็นคู่เดียวกัน เพื่อไม่ให้ label หลุดคนละบรรทัด; กลุ่ม action ใช้ grid 2 คอลัมน์และให้ action ยกเลิกแผนที่ยาวกินเต็มแถว |
