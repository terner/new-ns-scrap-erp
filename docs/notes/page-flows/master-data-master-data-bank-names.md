...
updated: 2026-06-11
route: /master-data/bank-names
---

# ชื่อธนาคาร Page Flow
...
bank name master for account snapshots and payment labels

## Page Responsibilities

- ดูแล master data ของ ชื่อธนาคาร
...
- `GET/POST /api/master-data/bank-names`
- `PATCH /api/master-data/bank-names/[id]`
- `GET/POST /api/master-data/bank-names; item API by id exists`
