...
updated: 2026-06-11
route: /master-data/product-types
---

# ประเภทสินค้า Page Flow
...
product type master used by products/filter/report

## Page Responsibilities

- ดูแล master data ของ ประเภทสินค้า
...
- `GET/POST /api/master-data/product-types`
- `PATCH /api/master-data/product-types/[id]`
- `GET/POST /api/master-data/product-types; item API by id exists`
