---
title: Production Line Page Flow
tags:
  - page-flow
  - menu
  - master-data
...
production line master for orders, machines, reports

## Page Responsibilities

- ดูแล master data ของ Production Line
...
- `GET/POST /api/master-data/production-lines`
- `PATCH /api/master-data/production-lines/[id]`
- `GET/POST /api/master-data/production-lines; item API by id exists`
