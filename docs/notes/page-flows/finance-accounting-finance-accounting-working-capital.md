---
title: Working Capital Analysis Page Flow
tags:
  - page-flow
  - menu
...
# Working Capital Analysis Page Flow
...
finance/accounting read model: Working Capital Analysis
...
- `GET /api/finance-accounting/working-capital`
