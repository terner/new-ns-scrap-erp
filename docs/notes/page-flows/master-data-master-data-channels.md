...
updated: 2026-06-11
route: /master-data/channels
---

# ช่องทางขาย Page Flow
...
sales/purchase channel master used by sales flow and reporting

## Page Responsibilities

- ดูแล master data ของ ช่องทางขาย
...
- `GET/POST /api/master-data/channels`
- `PATCH /api/master-data/channels/[id]`
- `GET/POST /api/master-data/channels; item API by id exists`
