...
machine master for production orders/utilization

## Page Responsibilities

- ดูแล master data ของ เครื่องจักร
...
- `GET/POST /api/master-data/machines`
- `PATCH /api/master-data/machines/[id]`
- `GET/POST /api/master-data/machines; item API by id exists`
