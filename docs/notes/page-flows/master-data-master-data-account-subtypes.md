---
title: ประเภทบัญชีธนาคาร Page Flow
tags:
  - page-flow
  - menu
  - master-data
...
updated: 2026-06-11
route: /master-data/account-subtypes
---

# ประเภทบัญชีธนาคาร Page Flow
...
account subtype master for company and party bank account classification

## Page Responsibilities

- ดูแล master data ของ ประเภทบัญชีธนาคาร
...
- `GET/POST /api/master-data/account-subtypes`
- `PATCH /api/master-data/account-subtypes/[id]`
- `GET/POST /api/master-data/account-subtypes; item API by id exists`
