---
title: ผู้รับเงินต่างประเทศ Page Flow
tags:
  - page-flow
  - menu
  - master-data
...
updated: 2026-06-11
route: /master-data/beneficiaries
---

# ผู้รับเงินต่างประเทศ Page Flow
...
foreign beneficiary master for international transfer flows

## Page Responsibilities

- ดูแล master data ของ ผู้รับเงินต่างประเทศ
...
- `GET/POST /api/master-data/beneficiaries`
- `PATCH /api/master-data/beneficiaries/[id]`
- `GET/POST /api/master-data/beneficiaries; item API by id exists`
