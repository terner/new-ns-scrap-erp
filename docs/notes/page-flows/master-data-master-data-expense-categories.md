---
title: หมวดค่าใช้จ่าย Page Flow
tags:
  - page-flow
  - menu
  - master-data
...
expense category master filtered by expense type

## Page Responsibilities

- ดูแล master data ของ หมวดค่าใช้จ่าย
...
- `GET/POST /api/master-data/expense-categories`
- `PATCH /api/master-data/expense-categories/[id]`
- `GET/POST /api/master-data/expense-categories; item API by id exists`
