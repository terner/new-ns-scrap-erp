...
- ส่วนสรุปเหนือรายการควรเน้นข้อมูลที่ช่วยตัดสินใจทันที โดยแสดง `ยอดคงเหลือ` และการกระจาย `จำนวนรายการค้างตามช่วงวัน` แบบย่อ; ไม่ต้องแสดง KPI รวมที่ซ้ำกับจำนวนรายการในตาราง
