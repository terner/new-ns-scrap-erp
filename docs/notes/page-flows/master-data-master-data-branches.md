...
branch master for document numbering, permission scope, stock/cash grouping

## Page Responsibilities

- ดูแล master data ของ สาขา
...
- `GET/POST /api/master-data/branches`
- `PATCH /api/master-data/branches/[id]`
- `GET/POST /api/master-data/branches; item API by id exists`
