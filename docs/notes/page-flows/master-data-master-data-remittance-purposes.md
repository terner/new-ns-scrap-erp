---
title: วัตถุประสงค์โอน Page Flow
tags:
  - page-flow
  - menu
  - master-data
...
updated: 2026-06-11
route: /master-data/remittance-purposes
---

# วัตถุประสงค์โอน Page Flow
...
remittance purpose master for foreign transfer compliance labels

## Page Responsibilities

- ดูแล master data ของ วัตถุประสงค์โอน
...
- `GET/POST /api/master-data/remittance-purposes`
- `PATCH /api/master-data/remittance-purposes/[id]`
- `GET/POST /api/master-data/remittance-purposes; item API by id exists`
