---
title: ประเภทเครื่องจักร Page Flow
tags:
  - page-flow
  - menu
  - master-data
...
updated: 2026-06-11
route: /master-data/machine-types
---

# ประเภทเครื่องจักร Page Flow
...
machine type master for machine grouping/reporting

## Page Responsibilities

- ดูแล master data ของ ประเภทเครื่องจักร
...
- `GET/POST /api/master-data/machine-types`
- `PATCH /api/master-data/machine-types/[id]`
- `GET/POST /api/master-data/machine-types; item API by id exists`
