...
updated: 2026-06-11
route: /master-data/product-units
---

# หน่วยสินค้า Page Flow
...
unit master for kg/case and document line unit snapshots

## Page Responsibilities

- ดูแล master data ของ หน่วยสินค้า
...
- `GET/POST /api/master-data/product-units`
- `PATCH /api/master-data/product-units/[id]`
- `GET/POST /api/master-data/product-units; item API by id exists`
