---
title: Equity / ทุนจดทะเบียน Page Flow
tags:
  - page-flow
  - menu
status: accepted-baseline
updated: 2026-06-11
route: /finance-accounting/equity-maint
---

# Equity / ทุนจดทะเบียน Page Flow
...
finance/accounting read model: Equity / ทุนจดทะเบียน
...
- `GET /api/finance-accounting/equity-maint`
