...
currency master for finance/accounting and foreign payment flows

## Page Responsibilities

- ดูแล master data ของ สกุลเงิน
...
- `GET/POST /api/master-data/currencies`
- `PATCH /api/master-data/currencies/[id]`
- `GET/POST /api/master-data/currencies; item API by id exists`
