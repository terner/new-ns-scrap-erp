...
- Production pages: `/production/orders`, `/production/output-categories`, `/production/dashboard`, `/production/wip-report`, `/production/report`, `/production/production-cost-report`
...
| Production reports | `/production/dashboard`, `/production/wip-report`, `/production/report`, `/production/production-cost-report` | dedicated `GET /api/production/...` read models using `loadProductionMetrics` | `production.operations.view` |
