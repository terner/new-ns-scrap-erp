...
flowchart TD
  ...
  Y --> E
  X -- ไม่ --> H[ADV = จ่ายแล้ว<br/>ยอด paid พร้อมนำไป allocate]
...
| `ADV` | source document ของเงินล่วงหน้า Supplier | `ยังไม่อนุมัติ`, `อนุมัติแล้วบางส่วน`, `อนุมัติแล้ว`, `จ่ายแล้ว`, `ใช้หักบิลบางส่วน`, `ใช้หักบิลแล้ว`, `ยกเลิก` |
