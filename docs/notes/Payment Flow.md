...
- `บัญชีที่จ่าย`
- `ยอดจ่ายล่วงหน้า`
- สำหรับ ADV แบบ invoice ให้เก็บ `เลข Invoice`, `ประเภท VAT`, `ยอดก่อน VAT`, `VAT amount`, และ `ยอดจ่ายจริงรวม VAT`
...
กติกาเพิ่มเติมสำหรับ ADV แบบ invoice:

- ถ้าเลือก `ไม่มี VAT` ให้ `PMA.approved_amount` เท่ากับยอดมัดจำก่อน VAT
- ถ้าเลือก `มี VAT` ให้ `PMA.approved_amount` เท่ากับยอดจ่ายจริงรวม VAT
- `PMT` ต้องจ่ายเต็มตาม `PMA.approved_amount` เหมือน source อื่น
- การนำ ADV ไปหัก `PB` เป็นหน้าที่ของ Purchase Flow โดยต้องหักฐานก่อน VAT และ VAT แยกกัน ไม่ใช้ยอดรวม VAT ไปหักฐานสินค้าโดยตรง
