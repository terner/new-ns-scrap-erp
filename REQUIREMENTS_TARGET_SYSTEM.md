...
- Status convert ไม่ใช่ production order และไม่ควรถูกรวมเป็น production output; ถ้ารายงาน Production ต้องแสดงผลจาก `SC` ให้แยก source label จาก production output
