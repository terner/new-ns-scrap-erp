...
- ถ้ามีสินค้าบริษัทจาก Stock ที่ต้องตัด stock จริง ต้องไม่ปะปนเป็น line ของบิลขาย Trading; ให้ใช้ flow ขาย Stock/WTO/PSALE ที่เป็น stock movement owner แยกต่างหาก
